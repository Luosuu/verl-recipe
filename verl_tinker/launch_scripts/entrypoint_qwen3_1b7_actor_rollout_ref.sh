#!/bin/bash
# VeRL-backed Tinker server entrypoint for Qwen3-1.7B.
#
# This script can be run directly in an interactive job, or used as the
# entrypoint for the formal Merlin launch config qwen3_1b7_grpo_colocated.yaml.
#
# Optional env vars:
...
SERVER_CONFIG="verl_tinker/configs/quick_start/actor_rollout_ref.yaml"

echo "=================================================="
echo "verl-recipes Tinker server (Qwen3-1.7B)"
